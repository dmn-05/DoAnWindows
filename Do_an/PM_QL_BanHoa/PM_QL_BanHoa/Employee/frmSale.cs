...
namespace PM_QL_BanHoa.Employee {
	public partial class frmSale : Form {
		...
		public bool addProductsToCart(int customerID, int productID, int quantity, double price, int state) {
			string queryString =
				"INSERT INTO GioHang (MaKH, MaSP, SoLuong, GiaBanLe, TrangThai) " +
				"VALUES (@MaKH, @MaSP, @SoLuong, @GiaBanLe, @TrangThai)";
		...
		private void btnAddToCart_Click(object sender, EventArgs e) {
			...
			bool isSuccess = addProductsToCart(customerID, productID, quantity, price, state);
